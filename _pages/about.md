...
💡 <strong><span style="color: #3274D8">My research interest lies in intelligent software reliability engineering (SRE), with focuses on:</span></strong>
- **AIDev**: automating software debugging, testing, and developing, especially using LLMs.
- **AIOps**: automating software troubleshooting in operations, especially for cloud computing systems.
